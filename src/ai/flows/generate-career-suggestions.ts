...
const careerSuggester = ai.definePrompt({
    ...
    **Process:**
    ...
    6.  **Generate a Featured Professional**: For the primary career, create a fictional \`featuredProfessional\` profile. This should feel like a real person. Generate a name that is culturally and ethnically appropriate for the user's country ({{{country}}}). The job title must match the primary career. Write a short, inspiring bio about how this professional balances their demanding career with a hobby, embodying the 'work hard, play hard' philosophy.
